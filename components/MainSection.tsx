...
import RentingFleet from "./RentingFleet";
      ...
      <section className="section-1">
        <div className="main-box h-[390px] border border-gray-800 m-1 flex justify-between items-center">
          <div className="booking-bike w-[750px] h-[350px] border border-green-500 ml-7">
            <h2 className="border border-gray-950 text-xl m-2 p-1">
              Two wheelers Rental
            </h2>
            <h1 className="border border-gray-600 text-2xl font-medium m-2 p-1">
              Book Your RideNow
            </h1>
            <p className="border border-gray-900 m-2 p-1">
              Start your jounery with easy and smooth with us.
            </p>
            ...
            <div className="border border-e-gray-950 w-[480px] h-[140px] m-2">
              <div className="border border-green-950 m-2 h-[120px]">
                ...
                <form
                  ...
                  className="w-[423px] h-[50px] border border-blue-900 flex justify-center items-center"
                >
                  <input
                    type="datetime-local"
                    name="start"
                  ...
                  <button
                    type="submit"
                    className="ml-3 px-2 hover:bg-gray-300 border border-gray-950 cursor-pointer"
                  >
                    Search
                  </button>
                </form>
